...
def accidents():
    ...
    for title, y in json_data_news.items():
        ...
        key_list1 = r' дтп\s|произош[е]*л\w*|случил[о]с*\w*|убийств\w*|подозрева\wт\w*\
                   ...
                   | угнан| укус\w* клещ|\bподлог|\bфиктивн'
        # key_list1 = ['[а-я]+[аеиюя]т\s',]#'[а-я]+ят ','[а-я]+ют ','[а-я]+ат ']
...
def jkh():
    ...
    for title, y in json_data_news.items():
        ...
        key_list1 = r'жкх|без газа|гасоснабж|канализац|отключен|отключат\
                    ...
                    |(холодн|горяч)[\s\w]{,10}(вод)| мусор| свалк|\sтбо\
...
def culture():
    ...
    for title, y in json_data_news.items():
        ...
        key_list1 = r'конкурс|фестивал|концерт|джаз\
                    ...
                    |композитор|культур|праздни[кч]|\bпоказ\
                    ...
                    |торжественн\w* открыти|ден\w* город\
