...
def head_title(num_news=0):
    ...
    # sing:[title,description,href,h3, keyword,h1]
    title_dict = {
        0: [f'Новости Курска и Курской области сегодня на СоваБот.ру',
            ...
            'novosti-za-sem-dnej',
            f'Что произошло в Курске и Курской области за последние 7 дней.'
            f' Подборка из {count_news[num_news]} новостей',
            f'новости курска, новости курска за неделю, курские новости, новости курской области,'
            f'новости одной строкой, лента новостей',
            'СВЕЖАЯ ЛЕНТА КУРСКИХ НОВОСТЕЙ'
             ],
        1: [f'Новости Курска и Курской области за {sss} на СоваБот.ру ',
            ...
            f'новости одной строкой, лента новостей',
            'ЛЕНТА КУРСКИХ НОВОСТЕЙ ЗА ВЧЕРА'
             ],
        2: [f'Новости Курска и Курской области за {sss} на СоваБот.ру ',
            ...
            'ЛЕНТА КУРСКИХ НОВОСТЕЙ ЗА ПОЗАВЧЕРА'
            ],
        ...
        17: [f'Последние ПОЖАРЫ в Курске и Курской области сегодня на СоваБот.ру ',
            ...
            f'Подборка из {count_news[num_news]} новостей',
             ...
             'ПОСЛЕДНИЕ НОВОСТИ: КУРСКИЕ ПОЖАРЫ'
             ],
        18: [f'Случаи мошенничества в Курске и Курской области сегодня на СоваБот.ру',
            ...
            f'Подборка из {count_news[num_news]} новостей',
             ...
             f' лента новостей',
             'ПОСЛЕДНИЕ НОВОСТИ: МОШЕННИЧЕСТВО'
             ],
        19: [f'КРАЖИ: сводка новостей из Курске и Курской области сегодня на СоваБот.ру',
            ...
            f'Подборка из {count_news[num_news]} новостей',
             ...
             f' лента новостей',
             'ПОСЛЕДНИЕ НОВОСТИ: КУРСКИЕ КРАЖИ'
             ],
        20: [f'Суды в Курске и Курской области сегодня на СоваБот.ру',
            ...
            f' Подборка из {count_news[num_news]} новостей',
             ...
             f' лента новостей',
             'ПОСЛЕДНИЕ НОВОСТИ: КУРСКИЕ СУДЫ'
             ],
        21: [f'СПЕЦОПЕРАЦИЯ НА УКРАИНЕ И КУРСКОЙ ОБЛАСТИ ',
            ...
            f'на сегодня. Подборка из {count_news[num_news]} новостей',
             ...
             f'новости одной строкой, лента новостей',
             'КУРСКИЕ НОВОСТИ О СПЕЦОПЕРАЦИИ'
             ],
        ...
        24: [f'Анонсы событий на послезавтра в Курске и Курской области на СоваБот.ру',
            ...
            f'Подборка из {count_news[num_news]} новостей',
             ...
             f'когда будет в Курске, когда наступит в Курске, когда произойдет в Курске,'
             f' новости одной строкой, лента новостей',
             'АНОНСЫ НОВОСТЕЙ НА ПОСЛЕЗАВТРА'
             ],
        ...
        26: [f'Объявления и информация по Курску и Курской области на СоваБот.ру',
            ...
            f'Подборка из {count_news[num_news]} новостей',
             ...
             f'когда будет в Курске, когда наступит в Курске, когда произойдет в Курске, '
             f'новости одной строкой, лента новостей',
             'АНОНСЫ: КУРСКИЕ ОБЪЯВЛЕНИЯ'
             ],
        27: [f'Новости Курска и Курской области сегодня на СоваБот.ру',
            f'"Узнавайте Главные новости Курска и Курской области на сегодня. Мы ежедневно '
            f'публикуем самую актуальную информацию. Репортажи, аналитика, происшествия, '
            f'ситуация на дорогах, новости политики, экономики, культуры и спорта.',
            'novosti-za-sem-dnej',
            f'Что произошло в Курске и Курской области за последние 24 часа.'
            f' Подборка из {count_news[num_news]} новостей',
            f'новости курска, новости курска сегодня, курские новости, новости курской области,'
            f'новости одной строкой, лента новостей, курские новости за день',
            'СВЕЖАЯ ЛЕНТА КУРСКИХ НОВОСТЕЙ'
            ],
    }
