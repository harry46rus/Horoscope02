...
def json_date(sorted_dict):
    ...
    path1 = f"C:\\Users\\79081\\PycharmProjects\\pyWEB_0\horoscope\dictionary\\bd_json\\{sec}.json"
...
def scrap():
    ...
    for root, directory, file in os.walk(
            'C:\\Users\\79081\\PycharmProjects\\pyWEB_0\horoscope\dictionary\\bd_json'):
        # print(root)
        # print(directory)
        for file_bd in file:
    ...
    path2=f"C:\\Users\\79081\\PycharmProjects\\pyWEB_0\horoscope\dictionary\\bd_json\\{max(fild_bd)}"
...
def loop_serv():
    ...
    while True:
        time_scrap = ['00:00', '00:20', '00:40', '01:00','01:33',
